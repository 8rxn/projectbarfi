...
function App() {
  ...
  return (
    <>
      ...
      <div className={` h-screen z-50 fixed left-[50%] top-[50%] -translate-x-[50%] -translate-y-[50%] grid place-items-center w-[100vw] shadow dark:bg-white/5 ${!profileActive?"hidden":""} `}>
