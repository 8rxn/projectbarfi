    ...
    <div className="h-[90vh] flex w-full bg-bg-primary gap-10 p-10">
      ...
      <div className="h-full  md:w-[80%] w-[100%] flex flex-col gap-10">
        ...
        <div className="w-[100%] flex sm:flex-row items-center flex-col md:gap-10 sm:gap-5 gap-2">
          ...
          />
          <button className="rounded-2xl border-2 border-color-primary text-color-primary md:text-xl text-md h-[70%]  hover:bg-gradient-to-r from-color-primary to-color-secondary hover:text-bg-primary hover:font-bold md:w-40 w-32 py-2 px-5 ease-in duration-150 ">
            {" "}
