  ...
  return (
    <div className='h-[90vh] flex w-full bg-bg-primary gap-10 p-10'>
       <div className='h-full w-[20%] md:flex flex-col items-center justify-center bg-bg-secondary border-color-primary border-2 rounded-3xl hidden'>
            ...
            <button className='border-2 rounded-2xl border-color-primary text-color-primary md:text-xl text-md h-[70%]  py-6 hover:bg-color-primary hover:text-color-secondary md:w-40 w-36 '> Send <AiOutlineSend className=' inline-block  ' /> </button>
            </div>
